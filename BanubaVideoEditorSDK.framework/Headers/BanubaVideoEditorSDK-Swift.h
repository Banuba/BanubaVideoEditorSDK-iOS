...
enum AdditionalEffectsButtonPosition : NSInteger;
@class UIColor;
...
@property (nonatomic) enum AdditionalEffectsButtonPosition position;
...
enum BackButtonPosition : NSInteger;
...
@property (nonatomic) enum BackButtonPosition position;
/// Initializes and returns the back button configuration object with specified configurations.
- (nonnull instancetype)initWithImageConfiguration:(ImageConfiguration * _Nonnull)imageConfiguration selectedImageConfiguration:(ImageConfiguration * _Nullable)selectedImageConfiguration position:(enum BackButtonPosition)position OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, BackButtonPosition, open) {
  BackButtonPositionLeft = 0,
  BackButtonPositionRight = 1,
};
...
///
/// \param isFaceAREnabled used to be able to run VideoEditor without Face AR
///
...
///
- (nonnull instancetype)initWithToken:(NSString * _Nonnull)token effectsToken:(NSString * _Nonnull)effectsToken isFaceAREnabled:(BOOL)isFaceAREnabled cloudMasksToken:(NSString * _Nullable)cloudMasksToken configuration:(VideoEditorConfig * _Nonnull)configuration analytics:(id <AnalyticsEngine> _Nullable)analytics externalViewControllerFactory:(id <ExternalViewControllerFactory> _Nullable)externalViewControllerFactory OBJC_DESIGNATED_INITIALIZER;
...
/// Modally presents Video editor’s trim view controller with pre-defined  PIP video
...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK21CameraSessionMetadata")
@interface CameraSessionMetadata : NSObject
- (nonnull instancetype)initWithIsFrontCamera:(BOOL)isFrontCamera OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithVideoResolution:(VideoResolutionConfiguration * _Nonnull)videoResolution galleryItemConfiguration:(GalleryItemConfiguration * _Nonnull)galleryItemConfiguration closeButtonConfiguration:(ImageButtonConfiguration * _Nonnull)closeButtonConfiguration albumButtonConfiguration:(TextButtonConfiguration * _Nonnull)albumButtonConfiguration nextButtonConfiguration:(SaveButtonConfiguration * _Nonnull)nextButtonConfiguration noItemsLabelConfiguration:(TextConfiguration * _Nonnull)noItemsLabelConfiguration layoutConfiguration:(GalleryLayoutConfiguration * _Nonnull)layoutConfiguration topBarBlurColor:(UIColor * _Nonnull)topBarBlurColor clearSelectionButtonConfiguration:(ImageButtonConfiguration * _Nonnull)clearSelectionButtonConfiguration galleryTypeButton:(TextButtonConfiguration * _Nonnull)galleryTypeButton galleryTypeUnderlineColor:(UIColor * _Nonnull)galleryTypeUnderlineColor isVideoEnabled:(BOOL)isVideoEnabled isPhotoEnabled:(BOOL)isPhotoEnabled isPhotoSequenceAnimationEnabled:(BOOL)isPhotoSequenceAnimationEnabled OBJC_DESIGNATED_INITIALIZER;
...
///
/// \param imageEdgeInsets Button image Edge
///
...
@property (nonatomic, strong) UIColor * _Nonnull backgroundColor;
- (nonnull instancetype)initWithIdentifier:(enum LayoutSetting)identifier textConfiguration:(TextConfiguration * _Nonnull)textConfiguration imageConfiguration:(ImageConfiguration * _Nonnull)imageConfiguration borderWidth:(CGFloat)borderWidth borderColor:(CGColorRef _Nonnull)borderColor isRoundedImageView:(BOOL)isRoundedImageView cornerRadius:(CGFloat)cornerRadius backgroundColor:(UIColor * _Nonnull)backgroundColor OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, LayoutSetting, open) {
  LayoutSettingFloating = 0,
  LayoutSettingTopBottom = 1,
  LayoutSettingReact = 2,
  LayoutSettingLeftRight = 3,
};
...
- (nonnull instancetype)initWithBackgroundConfiguration:(BackgroundConfiguration * _Nonnull)backgroundConfiguration dragIndicatorConfiguration:(RoundedButtonConfiguration * _Nonnull)dragIndicatorConfiguration titleConfiguration:(TextConfiguration * _Nonnull)titleConfiguration mainSettingsButtonsConfiguration:(NSArray<PIPSelectableCellConfiguration *> * _Nonnull)mainSettingsButtonsConfiguration additionalSettingsButtonsConfiguration:(NSArray<PIPSelectableCellConfiguration *> * _Nullable)additionalSettingsButtonsConfiguration OBJC_DESIGNATED_INITIALIZER;
/// BackgroundConfiguration setups background view style
@property (nonatomic, strong) BackgroundConfiguration * _Nonnull backgroundConfiguration;
/// Cursor color
...
@property (nonatomic, copy) NSArray<PIPSelectableCellConfiguration *> * _Nonnull mainSettingsButtonsConfiguration;
/// Main settings buttons’ configurations
@property (nonatomic, copy) NSArray<PIPSelectableCellConfiguration *> * _Nullable additionalSettingsButtonsConfiguration;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, strong) id <RecordButtonProvider> _Nonnull recordButtonProvider;
/// AdditionalEffectsButtonConfiguration array setups all of the camera screen control buttons’ styles
@property (nonatomic, copy) NSArray<AdditionalEffectsButtonConfiguration *> * _Nonnull additionalEffectsButtons;
...
- (nonnull instancetype)initWithTextConfiguration:(TextConfiguration * _Nullable)textConfiguration cornerRadius:(CGFloat)cornerRadius backgroundColor:(UIColor * _Nonnull)backgroundColor borderWidth:(CGFloat)borderWidth borderColor:(CGColorRef _Nullable)borderColor width:(CGFloat)width height:(CGFloat)height OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithSaveButton:(SaveButtonConfiguration * _Nonnull)saveButton backButton:(BackButtonConfiguration * _Nonnull)backButton rotateButton:(ImageButtonConfiguration * _Nullable)rotateButton throbber:(SmallActivityIndicatorConfiguration * _Nonnull)throbber trimTimeLineConfiguration:(TrimTimeLineConfiguration * _Nonnull)trimTimeLineConfiguration trimTimeLineHeight:(CGFloat)trimTimeLineHeight playerControlConfiguration:(PlayerControlConfiguration * _Nonnull)playerControlConfiguration backgroundConfiguration:(BackgroundConfiguration * _Nonnull)backgroundConfiguration screenNameConfiguration:(ScreenNameConfiguration * _Nonnull)screenNameConfiguration editedTimeLabelConfiguration:(TimeLabelConfiguration * _Nonnull)editedTimeLabelConfiguration OBJC_DESIGNATED_INITIALIZER;
/// SaveButtonConfiguration setups save button style
@property (nonatomic, strong) SaveButtonConfiguration * _Nonnull saveButton;
/// BackButtonConfiguration setups save button style
@property (nonatomic, strong) BackButtonConfiguration * _Nonnull backButton;
...
/// Initializes and returns the gradient configuration object with specified configurations.
- (nonnull instancetype)initWithAngle:(CGFloat)angle colors:(NSArray<UIColor *> * _Nonnull)colors OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK23TextShadowConfiguration")
...
/// Initializes and returns the timer configuration object with specified configurations.
- (nonnull instancetype)initWithDefaultButton:(ImageButtonConfiguration * _Nonnull)defaultButton options:(NSArray<TimerOptionConfiguration *> * _Nonnull)options OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, copy) NSString * _Nullable timerDescription;
...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK21TrimTimeRangeMetadata")
@interface TrimTimeRangeMetadata : NSObject
- (nonnull instancetype)initWithStart:(TimeMetadata * _Nonnull)start duration:(TimeMetadata * _Nonnull)duration OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class AudioBrowserConfigAdapter;
...
@property (nonatomic, strong) AudioBrowserConfigAdapter * _Nonnull audioBrowserConfiguration;
@property (nonatomic, strong) VideoResolutionConfiguration * _Nonnull videoResolutionConfiguration;
...
@class VideoSequenceItemMetadata;

SWIFT_CLASS("_TtC20BanubaVideoEditorSDK23VideoEditorTrimMetadata")
@interface VideoEditorTrimMetadata : NSObject
- (nonnull instancetype)initWithSequenceItemsMetadata:(NSArray<VideoSequenceItemMetadata *> * _Nonnull)sequenceItemsMetadata OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK25VideoSequenceItemMetadata")
@interface VideoSequenceItemMetadata : NSObject
- (nonnull instancetype)initWithVideoName:(NSString * _Nonnull)videoName order:(NSInteger)order imageData:(NSData * _Nullable)imageData isGalleryItem:(BOOL)isGalleryItem trimTimeRange:(TrimTimeRangeMetadata * _Nonnull)trimTimeRange OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
