...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK19AspectConfiguration")
@interface AspectConfiguration : NSObject
- (nonnull instancetype)initWithAspectRatio:(enum AspectRatio)aspectRatio image:(ImageButtonConfiguration * _Nonnull)image OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(uint8_t, AspectRatio, open) {
  AspectRatioOriginal = 0,
  AspectRatioAspect16x9 = 1,
  AspectRatioAspect9x16 = 2,
  AspectRatioAspect4x3 = 3,
  AspectRatioAspect4x5 = 4,
};

@class BackgroundConfiguration;

/// Aspects screen configuration
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK20AspectsConfiguration")
@interface AspectsConfiguration : NSObject
/// Setup image for cancel button
@property (nonatomic, strong) ImageButtonConfiguration * _Nonnull cancelButton;
/// Setup image for done button
@property (nonatomic, strong) ImageButtonConfiguration * _Nonnull doneButton;
...
@property (nonatomic, strong) UIColor * _Nonnull backgroundControlsViewColor;
/// Setup aspects
@property (nonatomic, copy) NSArray<AspectConfiguration *> * _Nonnull aspects;
/// Setup default aspect
@property (nonatomic) enum AspectRatio defaultAspect;
- (nonnull instancetype)initWithCancelButton:(ImageButtonConfiguration * _Nonnull)cancelButton doneButton:(ImageButtonConfiguration * _Nonnull)doneButton backgroundConfiguration:(BackgroundConfiguration * _Nonnull)backgroundConfiguration backgroundControlsViewColor:(UIColor * _Nonnull)backgroundControlsViewColor aspects:(NSArray<AspectConfiguration *> * _Nonnull)aspects defaultAspect:(enum AspectRatio)defaultAspect OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// watermark and video quality
///
/// \param completion completion: (success, error, exportCoverImages), execute on background thread.
///
- (void)exportVideosWithCoverImageUsing:(NSArray<ExportVideoConfiguration *> * _Nonnull)configurations completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable, ExportCoverImages * _Nonnull))completion;
...
@property (nonatomic) BOOL isVideoAspectFillEnabled;
- (void)applySimpleSDKButtons;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Container for cover image and gif url
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK17ExportCoverImages")
@interface ExportCoverImages : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, strong) GifSettings * _Nullable gifSettings;
/// ExportVideoConfiguration constructor.
- (nonnull instancetype)initWithFileURL:(NSURL * _Nonnull)fileURL quality:(ExportQuality * _Nonnull)quality useHEVCCodecIfPossible:(BOOL)useHEVCCodecIfPossible watermarkConfiguration:(WatermarkConfiguration * _Nullable)watermarkConfiguration gifSettings:(GifSettings * _Nullable)gifSettings OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// The settings for gif
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK11GifSettings")
@interface GifSettings : NSObject
/// The animate duration
@property (nonatomic) NSTimeInterval duration;
/// GifSettings constructor.
...
- (nonnull instancetype)initWithTracks:(NSArray<MusicEditorTrack *> * _Nonnull)tracks videoVolume:(float)videoVolume OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSArray<MusicEditorTrack *> * _Nonnull tracks;
@property (nonatomic) float videoVolume;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) NSTimeInterval compositionStart;
@property (nonatomic) NSTimeInterval timeRangeStart;
@property (nonatomic) NSTimeInterval timeRangeEnd;
@property (nonatomic) BOOL isAudioRecord;
@property (nonatomic) BOOL isEditable;
@property (nonatomic) NSInteger applyedFilterId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class SpeedBarButtonsConfiguration;
...
@property (nonatomic, strong) BanubaButtonConfiguration * _Nonnull backToDraftsButton;
...
@property (nonatomic, strong) SpeedBarButtonsConfiguration * _Nonnull speedBarButtons;
...
SWIFT_CLASS("_TtC20BanubaVideoEditorSDK28SpeedBarButtonsConfiguration")
@interface SpeedBarButtonsConfiguration : NSObject
...
- (nonnull instancetype)initWithImageNameHalf:(NSString * _Nonnull)imageNameHalf imageNameNormal:(NSString * _Nonnull)imageNameNormal imageNameDouble:(NSString * _Nonnull)imageNameDouble imageNameTriple:(NSString * _Nonnull)imageNameTriple selectedTitleColor:(UIColor * _Nonnull)selectedTitleColor titleColor:(UIColor * _Nonnull)titleColor backgroundColor:(UIColor * _Nonnull)backgroundColor cornerRadius:(CGFloat)cornerRadius OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, strong) ImageButtonConfiguration * _Nullable aspectsButton;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithImageData:(NSData * _Nullable)imageData coverIndents:(NSArray<TimeMetadata *> * _Nonnull)coverIndents OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, strong) UIImage * _Nullable image;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)updateExtendedVideoCoverSelectionFonts:(UIFont * _Nonnull)font;
...
- (nonnull instancetype)initWithIsSlideShow:(BOOL)isSlideShow isDrafted:(BOOL)isDrafted name:(NSString * _Nonnull)name sequenceParentName:(NSString * _Nullable)sequenceParentName editingStep:(enum VideoSequenceEditingStep)editingStep musicTrack:(MediaTrack * _Nullable)musicTrack aspect:(enum AspectRatio)aspect OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic) enum AspectRatio aspect;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
